...
# -*- coding: utf-8 -*-
"""
Created on Wed Dec 16 13:41:05 2020

@author: mjfields
"""

__all__ = ['InitialConditions', 'Moves', 'PhotometryMetadata', 'DSADataFrame']
...
class DSADataFrame(pd.DataFrame):
    ...
    meta_base_type : str, optional
        Which of 'posterior', 'photometry', or 'chains' is being made a `DSADataFrame`.
        Adds specific metadata for those three options. If `None` (default), no
        metadata is assigned.
    metadata : dict, optional
        Additional metadata assigned to the `DSADataFrame`. The default is `None`.
    
    """
    
    def __init__(self, *args, meta_base_type=None, metadata=None, **kwargs):
        
        super(DSADataFrame, self).__init__(*args, **kwargs)
    ...
    def __setattr__(self, attr, val):
        ...
        if attr == "metadata":
            ...
            super(DSADataFrame, self).__setattr__(attr, val)
